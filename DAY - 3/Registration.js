...
const Registration = () => {
  ...
  <div>
      ...
      <select className="select" id="currencySelect" value={currency} onChange={handleCurrencyChange}>
        <option className="option"value="INR">INR - Indian Rupee</option>
        <option className="option" value="USD">USD - US Dollar</option>
        <option className="option" value="EUR">EUR - Euro</option>
        <option className="option" value="GBP">GBP - British Pound</option>
        <option className="option"value="JPY">JPY - Japanese Yen</option>
      </select>
